...
impl AppState {
    ...
    fn add_new_tab(&self) {
        ...
        let (new_tab_sender, new_tab_receiver) = cushy::channel::build()
            .finish();
    ...
    fn create_document(&self, tab_key: TabKey, mut name: String, mut path: PathBuf, kind: KindChoice) -> Task<AppMessage> {
        ...
        let (document_tab_sender, document_tab_receiver) = cushy::channel::build()
            .finish();
        ...
        match kind {
            ...
            KindChoice::Image => {
                ...
                let (image_document_sender, image_document_receiver) = cushy::channel::build().finish();
